...
const Card = () => {
  ...
  console.log("card item", cardItems.length);
  ...
  return (
    <>
      {cardItems && cardItems.length === 0 ? (
        <div className="flex font-custom text-2xl h-80 items-center justify-center">
            ...
            <div className="grid grid-cols-1 justify-items-center md:justify-items-stretch  md:grid-cols-2 lg:grid-cols-5 ">
              {cardItems.map((card, i) => (
                ...
                <div
                  ...
                  className="max-w-60  mr-5 mb-5 h-[26rem]  overflow-clip bg-gray-50 border border-gray-200 rounded-lg shadow dark:border-gray-200"
                >
                  ...
                  <div className="p-3">
                    ...
                    <h2 className="font-bold mb-2">
                      ₹{card?.product?.price}
                      <span className="ml-10">quantity: {card?.quantity}</span>
                    </h2>

                    <div className="relative ">
                      <button
                        onClick={() => handleRemoveItem(card?.product?._id)}
                        className="border-2 border-violet-900 text-violet-900 hover:bg-violet-900 hover:text-white rounded absolute left-3 py-1 font-bold h-8 w-48"
                      >
                        REMOVE CARD
                      </button>
                    </div>
